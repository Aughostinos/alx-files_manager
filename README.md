...
*   Weight: 1
*   Project to be done in teams of 2 people (your team: Augustinos Abusaif)
*   Project will start Oct 10, 2024 6:00 AM, must end by Oct 17, 2024 6:00 AM
*   Checker was released at Oct 12, 2024 12:00 AM
...
#### Correction of "3. Create a new user"
...
#### Correction of "4. Authenticate a user"
...
#### Correction of "6. Get and list file"
...
#### Correction of "7. File publish/unpublish"
...
*   Otherwise:
    *   By using the module `mime-types`, get the [MIME-type](/rltoken/d9Q53g6bNHvm1IvBQyOxyw "MIME-type") based on the `name` of the file
...
In real life, you can use a third party service like [Mailgun](/rltoken/Lr8MoeTgC7KRx413wpoBXg "Mailgun") to send real email. These API are slow, (sending via SMTP is worst!) and sending emails via a background job is important to optimize API endpoint.
